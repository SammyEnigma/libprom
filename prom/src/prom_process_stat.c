...
prom_gauge_t *prom_process_rss_memory_bytes;
...
int prom_process_stats_init(void) {
  ...
  prom_process_rss_memory_bytes =
      prom_gauge_new("process_rss_memory_bytes", "Resident set size of memory in bytes.", 0, NULL);
